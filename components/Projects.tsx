...
const jobProjects = [
  {
    imagePath: "/web-app.jpeg",
    title: "Online Learning Sentiment Web App",
    description:
      "Developed an online learning sentiment analysis web app employing Python, Streamlit, and Tweepy.",
    skills: [
      "Python",
      "Streamlit",
      "Tweepy",

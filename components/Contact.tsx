  ...
  return (
    <section id="contact" className="scroll-mt-16 lg:mt-16">
      ...
      <div className="flex flex-col gap-4 lg:px-6 mb-8">
        ...
        If you have a role that aligns with my skills in software development 
        or if you're interested in discussing the latest in technology or even sharing a chat about football, 
        please feel free to reach out
        </p>
      </div>
      <div className="flex flex-row justifyF-center items-center gap-4 lg:px-6 mb-4">
        <a
          href="mailto:anindamandal60@gmail.com"
          target="_blank"
